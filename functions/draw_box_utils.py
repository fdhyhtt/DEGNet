...
def draw_text(draw,
              ...
              font_hz=None):
    """
    Draw the target bounding box and category information onto the image
    """
    try:
...
def draw_objs(image: Image,
    ...
    """
    Draw the target bounding box information, category information, and mask information on the image
    Args:
        image: Pictures to be drawn
        ...
        category_index: Category and Name
    ...
    if draw_boxes_on_image:
        ...
        for box, cls, score, color in zip(boxes, classes, scores, colors):
            ...
            draw_text(draw, box.tolist(), int(cls), float(score), category_index, color, font, font_size, font_hz)
